...
import { DollarSign, TrendingUp, TrendingDown, Clock, Activity, Tags } from 'lucide-react';
                    ...
                    <div className="summary-grid">
                        ...
                        <div className="stat-card net-sales">
                            ...
                            <div className="stat-info">
                                ...
                                <p className="amount text-blue-400">{formatCurrency(summary.totalSales - summary.totalExpenses)}</p>
                            </div>
                        </div>

                        <div className={`stat-card net-balance ${summary.netAmount >= 0 ? 'positive' : 'negative'}`}>
