...
INSERT INTO "new_sales_h" ("branch_id", "created_at", "discount", "id", "payment_method", "tax", "total", "user_id") SELECT "branch_id", "created_at", "discount", "id", "payment_method", "tax", "total", "user_id" FROM "sales_h";
DROP TABLE "sales_h";
