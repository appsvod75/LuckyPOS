...
const getAllProducts = async (req, res) => {
    ...
    try {
        ...
        const formatted = products.map(p => ({
            ...p,
            is_medicine: p.isMedicine, // Map Prisma camelCase to frontend snake_case
...
const getProductById = async (req, res) => {
    ...
    try {
        ...
        const formatted = {
            ...
            is_medicine: product.isMedicine,
...
const createProduct = async (req, res) => {
    const { name, sku, categoryId, basePrice, isMedicine, isService, description, imageUrl, variants, minStock, maxStock, providerIds } = req.body;
